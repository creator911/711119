...
const testDirectory = await mkdtemp(path.join(tmpdir(), "nara-announcements-"));
const password = "AnnouncementOwner!2026";
const port = 3122;
const env = {
  ...process.env,
...
try {
  ...
  run("tests/system-announcements-integration.mjs", {
