...
export async function GET(request: Request) {
  ...
  const [health, posts, blockedIps, totalMembers, activeMembers, todayMembers, todayPosts, todayAttendance, supportUnread, partnerUnread, shopLowStockProducts] = await Promise.all([
    loadSystemHealth(env.DB, {
      driver,
      cache: env.CACHE,
      media: env.MEDIA,
